...
<title>Case 4 - Injection into string values in an update page with different valid responses</title>
</head>
<body>
...
%>
    ...
    <form name="frmInput" id="frmInput" action="Case04-InjectionInUpdate-String-CommandInjection-WithDifferent200Responses.jsp" method="POST">
