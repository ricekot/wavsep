...
<title>Case 5 - Injection into an order by clause (any type) in a search page with different valid responses</title>
</head>
<body>
...
%>
    ...
    <form name="frmInput" id="frmInput" action="Case05-InjectionInSearchOrderBy-String-BinaryDeliberateRuntimeError-WithDifferent200Responses.jsp" method="POST">
