...
<title>Case 11 - Injection into a date value in a private resource view page with different valid responses</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case11-InjectionInView-Date-PermissionBypass-WithDifferent200Responses.jsp" method="POST">
