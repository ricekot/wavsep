...
<title>Case 6 - Injection into a numeric value in a private resource view page with different valid responses</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case06-InjectionInView-Numeric-PermissionBypass-WithDifferent200Responses.jsp" method="POST">
