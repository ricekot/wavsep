...
<title>Case 16 - Injection into a numeric value in a private resource view page with different valid responses and quote validation</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case16-InjectionInView-NumericWithoutQuotes-PermissionBypass-WithDifferent200Responses.jsp" method="POST">
