...
<title>Case 10 - Injection into an order by clause (numeric) in a search page with different valid responses</title>
</head>
<body>
...
%>
	...
	<form name="frmInput" id="frmInput" action="Case10-InjectionInSearchOrderBy-Numeric-BinaryDeliberateRuntimeError-WithDifferent200Responses.jsp" method="POST">
