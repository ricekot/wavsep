...
<title>Case 9 - Injection into numeric values in an update page with different valid responses</title>
</head>
<body>
...
%>
    ...
    <form name="frmInput" id="frmInput" action="Case09-InjectionInUpdate-Numeric-CommandInjection-WithDifferent200Responses.jsp" method="POST">
