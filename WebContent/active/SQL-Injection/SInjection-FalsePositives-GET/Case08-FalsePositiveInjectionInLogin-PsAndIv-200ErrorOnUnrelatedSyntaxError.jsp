...
<title>Case 8 - False Positive Injection in a login page that always responds with erroneous 200 HTTP response since it has an internal unrelated syntax error</title>
</head>
<body>
